...
ask the user which saved networks he want to connect 
DISCONNECT the currently connected networks
if preferrednetwrok not in saved than end of the netwreok
if preferred netowrk saved then check whether it is avaialbe or not 
if available then connect 
'''
import os
import sys
